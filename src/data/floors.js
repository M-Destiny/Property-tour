...
export const FLOORS = [
  { n: "L",  name: "Lobby & Arrival",    use: "Public · Reception", area: "8,400", plan: "lobby",
    beds: "—", baths: "—", ceil: "21ft", status: "available", price: "—",
  ...
  { n: "02", name: "Retail Galleria",    use: "Retail", area: "7,900", plan: "office",
    beds: "—", baths: "2", ceil: "16ft", status: "available", price: "On Request",
  ...
  { n: "03", name: "Café & Co-work",     use: "Hospitality", area: "7,900", plan: "office",
    beds: "—", baths: "2", ceil: "14ft", status: "available", price: "On Request",
  ...
  { n: "04", name: "Corporate Suite 04", use: "Office", area: "7,200", plan: "office",
    beds: "—", baths: "2", ceil: "12ft", status: "available", price: "₹ 185 /sf/mo",
  ...
  { n: "05", name: "Corporate Suite 05", use: "Office", area: "7,200", plan: "office",
    beds: "—", baths: "2", ceil: "12ft", status: "reserved", price: "₹ 185 /sf/mo",
  ...
  { n: "06", name: "Corporate Suite 06", use: "Office", area: "7,200", plan: "office",
    beds: "—", baths: "2", ceil: "12ft", status: "available", price: "₹ 190 /sf/mo",
  ...
  { n: "07", name: "Corporate Suite 07", use: "Office", area: "7,200", plan: "office",
    beds: "—", baths: "2", ceil: "12ft", status: "available", price: "₹ 195 /sf/mo",
  ...
  { n: "08", name: "Corporate Suite 08", use: "Office", area: "7,200", plan: "office",
    beds: "—", baths: "2", ceil: "12ft", status: "sold", price: "₹ 200 /sf/mo",
  ...
  { n: "09", name: "Residence 09", use: "Residential", area: "1,180", plan: "apartment",
    beds: "2", baths: "2", ceil: "10ft", status: "sold", price: "₹ 6.8 Cr",
    blurb: "A two-bedroom corner residence — open living around a chef kitchen, a primary suite with walk-in robe, and a glass balcony.",
  ...
  { n: "10", name: "Residence 10", use: "Residential", area: "1,180", plan: "apartment",
    beds: "2", baths: "2", ceil: "10ft", status: "available", price: "₹ 7.2 Cr",
  ...
  { n: "11", name: "Residence 11", use: "Residential", area: "1,240", plan: "apartment",
    beds: "2", baths: "2", ceil: "10ft", status: "reserved", price: "₹ 7.8 Cr",
  ...
  { n: "12", name: "Residence 12", use: "Residential", area: "1,240", plan: "apartment",
    beds: "2", baths: "2", ceil: "10ft", status: "available", price: "₹ 8.2 Cr",
  ...
  { n: "13", name: "Sky Lounge", use: "Amenities", area: "6,800", plan: "amenity",
    beds: "—", baths: "2", ceil: "15ft", status: "available", price: "Residents Only",
  ...
  { n: "14", name: "The Penthouse", use: "Residential", area: "3,400", plan: "penthouse",
    beds: "3", baths: "3.5", ceil: "12ft", status: "available", price: "₹ 42 Cr",
    blurb: "A single full-floor penthouse — great room under 12-foot ceilings, three suites, a wine room and a 360-degree wrap terrace.",
